...
import ir.technopedia.wordpressjsonclient.util.TypefaceUtil;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarLogo = (TextView) findViewById(R.id.toolbarTextView);
        Font font = new Font();
        font.setFontLogo(getApplicationContext(),toolBarLogo);
        ...
        font.setFont(getApplicationContext(),comentCount);*/
